...
function Signature() {
    ...
    return (
        ...
        {/* Mobile */}
        <div className="hidden  text-white h-[110vw] bg-primary bottom-0 left-0 w-full pv:max-md:flex flex-col justify-center items-start pl-[9vw] pr-[9%] border-t-[1px] border-white">
              ...
              <p className='font-shopee_bold text-left text-white text-[5vw] pt-[10vw]'>FOLLOW</p>
