  ...
  return (
    <div className="py-10">
      ...
      <div className="pv:max-md:hidden pt-[72px] grid grid-cols-2 gap-[15vw]  pv:max-md:grid-cols-1  pv:max-md:pt-10 pv:max-md:gap-0 md:max-xl:grid-cols-2 md:max-xl:grid">
        ...
        <div className="">
          <img
            className="object-cover pv:max-md:w-[90%] pv:max-md:mx-auto pv:max-md:h-[300px] pv:max-ph:rounded-lg"
        ...
        <div className="">
          <img
            className="object-cover pv:max-md:w-[100%] pv:max-md:mx-auto pv:max-md:h-[300px] pv:max-md:my-[8vw] pv:max-ph:rounded-3xl"
            src={`${process.env.REACT_APP_SERVER_URL}/${imgTitle}`}
          ></img>
        </div>
          <div className="flex  flex-col  gap-[20px]  pv:max-md:gap-4 ">
