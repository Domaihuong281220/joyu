      ...
      <>
        ...
        <div className='h-[65.5vw] pv:max-md:hidden w-full z-50 flex flex-row items-end bg-primary " id="sidebar'>
          <div className="absolute z-10 top-0 left-0 w-full h-[10vw] flex justify-center items-end px-[11.7%] py-4">
            ...
            <div className="w-full h-full flex justify-end space-x-4 items-end">
              ...
              <button className="font-nexa_light uppercase border-[1px] border-white text-white text-secondary h-fit rounded-full px-[4vw] py-[1.1vw] text-[1vw]" onClick={() => {
                navigate("../" + path.MENU);
                setOpenSidebar(false);
                sessionStorage.setItem("openSidebar", false);
              }}>
          ...
          <div className="w-3/5 h-full  relative">
            ...
            <p className='w-full text-start pl-[3.2vw] font-nexa_light font-black  text-white text-[1.3vw] pt-[2vw]'>Copyright JoYu Tea & Coffee 2022. All Rights Reserved</p>
          </div>
            </div>
          </div>
        </div>
        ...
        <div className='h-[310vw] w-full z-50 hidden pv:max-md:flex flex-row items-end bg-primary " id="sidebar'>
          <div className="hidden absolute z-10 top-[12vw] left-0 w-full h-[20vw] pv:max-md:flex justify-center items-end px-[8%] py-4">
            ...
            <div className="w-full h-full flex justify-end space-x-[6vw] items-end">
              <button className="font-nexa font-black uppercase border-[1px] border-white text-white h-fit rounded-full  pb-[1.5vw] pt-[2.5vw]  w-[42vw] text-[5vw]" onClick={() => {
                navigate("../" + path.MENU);
                setOpenSidebar(false);
                sessionStorage.setItem("openSidebar", false);
              }}>
          ...
          <div className="w-full h-full relative">
            <img src={sidebarmobileBG} alt="" className="object-contain object-top h-full" />
            <div className="absolute top-[18vw] left-[2vw] w-full h-[75%] flex flex-col space-y-[4vw] justify-start pt-[30vw] items-center font-nexa text-white text-[8vw]">
              ...
              >
                ...
                <p className="font-nexa_bold font-black opacity-50">Locations</p>
              </div>
              <div
                className="flex w-full h-fit space-x-[3vw] cursor-pointer"
                onClick={() => {
              ...
              >
                ...
                <p className="font-nexa_bold font-black opacity-50">Our Story</p>
              </div>
              <div
                className="flex w-full h-fit space-x-[3vw] cursor-pointer"
                onClick={() => {
              ...
              >
                ...
                <p className="font-nexa_bold font-black opacity-50 ">Catering</p>
              </div>
              <div
                className="flex w-full h-fit space-x-[3vw] cursor-pointer"
                onClick={() => {
              ...
              >
                ...
                <p className="font-nexa_bold font-black opacity-50">Franchising</p>
              </div>
              <div
                className="flex w-full h-fit space-x-[3vw] cursor-pointer"
                onClick={() => {
