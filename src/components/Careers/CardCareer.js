...
const CardCareer = ({ title, desc, subdesc, Responsibilities, img }) => {
  return (
    <div className="">
      <div className="grid grid-cols-3 gap-20  pv:max-lg:hidden ">
        <div className="col-span-2  ">
          ...
          <div className="text-start flex flex-col gap-2">
            {Responsibilities.map((item, index) => {
              return (
                <p className="font-nexa_light text-[1.3vw] pb-[1vw]">
                  - {item}
                </p>
              );
            })}
      ...
      <div className="grid grid-cols-1 gap-20  lg:hidden  ">
        ...
        <div className="col-span-1  h-full">
          <img
            className="rounded-[20px] h-full w-[80%] mx-auto object-cover"
            src={img}
          ></img>
        </div>
